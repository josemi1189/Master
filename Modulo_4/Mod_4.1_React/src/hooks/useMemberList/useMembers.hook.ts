...
//import { getMembersApi } from "./members.api";
import { mapMemberListtoVM } from "./member.mapper";

export const useMembers = (organization: string) => {
  ...
  useEffect(() => {
    const fetchMembers = async () => {
      ...
      try {
        ...
        //const dataMapped = await getMembersApi(organization).then(mapMemberListtoVM);
